...
class TimetablingProblem:
    ...
    def __init__(self, hardConstraintPenalty):
        ...
        self.timeslots = [
            "Sat-08:30", "Sat-10:45", "Sat-13:30", "Sat-15:45",
            "Sun-08:30", "Sun-10:45", "Sun-13:30", "Sun-15:45",
        ]
    ...
    def getCost(self, timetable):
        ...
        hardViolations = roomClashes + lecturerClashes + groupClashes + roomCapacityViolations
        ...
        return self.hardConstraintPenalty * hardViolations + softViolations + dayOrderViolations
    ...
    def countDayOrderViolations(self, timetable):
        ...
        for group_id, slots in group_classes.items():
            ...
            if len(sunday_classes) > 0 and len(saturday_classes) < len(self.saturday_slots):
                # More penalty if more Sunday classes and more empty Saturday slots
                violations += (len(sunday_classes) * (len(self.saturday_slots) - len(saturday_classes)))
    ...
    def isValidTimetable(self, timetable):
        ...
        if (self.countRoomClashes(formatted_timetable) > 0 or
            self.countLecturerClashes(formatted_timetable) > 0 or
            self.countGroupClashes(formatted_timetable) > 0 or
            self.countRoomCapacityViolations(formatted_timetable) > 0):
            return False
    ...
    def plotData(self, timetable):
        ...
        print("Day order violations (Sunday before Saturday filled) =", dayOrderViolations)
        print()
